...
led_set_1 = PWM(Pin(15))  # First set of LEDs (white)
led_set_2 = PWM(Pin(16))  # Second set of LEDs (violet)
...
while True:
    ...
    if capture_stage == 1:
        print('led1')
        led_set_1.duty_u16(49151.25)  # Set brightness to 75%
        ...
        print('led2')
        led_set_2.duty_u16(49151)  # Set brightness to 75%
        time.sleep(0.1)  # Small delay
